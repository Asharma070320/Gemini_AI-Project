...
import {googleprovider} from '../auth/firebase'
...
const SignUp = () => {
    ...
    const googleBtn = async() => {
        try{
           ...
           alert("Goggle Logged In Succesful");
           navigate("/")
        }catch(err){
            console.log(err);
        }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 transition-all duration-500 hover:shadow-purple-500/25">
          ...
          <div className="space-y-6">
            ...
            {/* Submit Button */}
            <button onClick={createAccountBtn} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/50 cursor-pointer">
              Create Account
            </button>
          </div>
          ...
          {/* Google Sign In */}
          <button onClick={googleBtn} className="w-full bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-3 cursor-pointer">

...
import { Eye, EyeOff, Mail, Lock, User, Sparkles, ArrowRight, Shield, Zap, UserPlus } from 'lucide-react';
...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-40 right-32 w-1 h-1 bg-indigo-300/50 rounded-full animate-ping"></div>
            ...
            <div className="absolute top-1/2 left-10 w-1 h-1 bg-white/40 rounded-full animate-ping animation-delay-1000"></div>
            <div className="absolute top-3/4 right-10 w-2 h-2 bg-indigo-300/30 rounded-full animate-pulse animation-delay-3000"></div>
                ...
                <div className="bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/20 p-8 transition-all duration-500 hover:shadow-purple-500/25 hover:border-white/30">
                    ...
                    <div className="text-center mb-8">
                        <div className="relative inline-block mb-4">
                            <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto shadow-2xl">
                                <UserPlus className="w-8 h-8 text-white" />
                            </div>
                            <div className="absolute inset-0 w-16 h-16 bg-gradient-to-r from-indigo-400 to-pink-400 rounded-2xl mx-auto animate-ping opacity-20"></div>
                        </div>
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mb-2">
                            Create Account
                        </h1>
                        <p className="text-white/70 text-sm">
                            Join thousands of users on their AI journey
                        </p>
                    </div>
